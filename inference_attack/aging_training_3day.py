...
REBUILD = False
CACHE_FILE = 'aging3d_2'
CACHE_FILE2 = 'aging3d__xy2'
CACHE_FILE3 = 'aging3d__xy3'
...
if REBUILD or data3 is None: 
    ...
    training_labels = list(sorted(set(y_train_0 + y_train_1 + y_train_2)))
    ...
    for day in days:
        ...
        for _ in range(repeat):
            ...
            # Accuracy vs Day 0
            X_past_train_1, _, y_past_train_1, _ = train_test_split(X_train_0,  y_train_0,  stratify=y_train_0, train_size=n_labels*3)
            X_past_train_2, _, y_past_train_2, _ = train_test_split(X_train_1,  y_train_1,  stratify=y_train_1, train_size=n_labels*2)
            X_past_train_3, _, y_past_train_3, _ = train_test_split(X_train_2,  y_train_2,  stratify=y_train_2, train_size=n_labels*2)

            X_past_train = X_past_train_1 + X_past_train_2 + X_past_train_3
            y_past_train = y_past_train_1 + y_past_train_2 + y_past_train_3
...
with open('plots/aging_per_class_3d.json', 'w') as f:
    f.write(json_str)
