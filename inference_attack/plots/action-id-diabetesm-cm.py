...
[y_test, y_pred] = deserialize("action-id-diabetesm-cm.json")
...
write_latex_table_precision_recall_f1("action-id-diabetesm-cm.tex", y_test, y_pred)

plt.tight_layout()
plt.savefig('action-id-diabetesm-cm.png', format='png')
plt.savefig('action-id-diabetesm-cm.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-cm.png/eps")
