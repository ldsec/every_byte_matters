...
[y_test, y_pred] = deserialize("action-id-diabetesm-def-add_dummies-cm.json")
...
write_latex_table_precision_recall_f1("action-id-diabetesm-def-add_dummies-cm.tex", y_test, y_pred)
plt.tight_layout()
plt.savefig('action-id-diabetesm-def-add_dummies-cm.png', format='png')
plt.savefig('action-id-diabetesm-def-add_dummies-cm.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-def-add_dummies-cm.png/eps")
