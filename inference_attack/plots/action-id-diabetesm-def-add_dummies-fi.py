...
features_and_percentages = deserialize("action-id-diabetesm-def-add_dummies-fi.json")
...
plt.savefig('action-id-diabetesm-def-add_dummies-fi.png', format='png')
plt.savefig('action-id-diabetesm-def-add_dummies-fi.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-def-add_dummies-fi.png/eps")
