...
features_and_percentages = deserialize("action-id-diabetesm-def-delay_group-fi.json")
...
plt.savefig('action-id-diabetesm-def-delay_group-fi.png', format='png')
plt.savefig('action-id-diabetesm-def-delay_group-fi.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-def-delay_group-fi.png/eps")
