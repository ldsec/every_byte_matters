...
features_and_percentages = deserialize("action-id-diabetesm-def-pad-fi.json")
...
plt.savefig('action-id-diabetesm-def-pad-fi.png', format='png')
plt.savefig('action-id-diabetesm-def-pad-fi.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-def-pad-fi.png/eps")
