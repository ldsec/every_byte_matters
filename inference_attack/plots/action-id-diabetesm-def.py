...
defense_results2 = deserialize("action-id-diabetesm-def.json")
...
write_latex_table_defense("action-id-diabetesm-def.tex", defense_results, labelFormat="\\defense", headerRow=False)
