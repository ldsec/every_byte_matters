...
features_and_percentages = deserialize("action-id-diabetesm-fi.json")
...
plt.savefig('action-id-diabetesm-fi.png', format='png')
plt.savefig('action-id-diabetesm-fi.png'.replace('.png', '.eps'), format='eps')
print("Written action-id-diabetesm-fi.png/eps")
