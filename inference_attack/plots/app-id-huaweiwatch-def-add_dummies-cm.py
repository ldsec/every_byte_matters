...
[y_test, y_pred] = deserialize("app-id-huaweiwatch-def-add_dummies-cm.json")
...
write_latex_table_precision_recall_f1("app-id-huaweiwatch-def-add_dummies-cm.tex", y_test, y_pred)

ax.get_xaxis().set_ticks([])
ax.get_yaxis().set_ticks([])
plt.tight_layout()
plt.savefig('app-id-huaweiwatch-def-add_dummies-cm.png', format='png')
plt.savefig('app-id-huaweiwatch-def-add_dummies-cm.png'.replace('.png', '.eps'), format='eps')
print("Written app-id-huaweiwatch-def-add_dummies-cm.png/eps")
