...
features_and_percentages = deserialize("app-id-huaweiwatch-def-add_dummies-fi.json")
...
plt.savefig('app-id-huaweiwatch-def-add_dummies-fi.png', format='png')
plt.savefig('app-id-huaweiwatch-def-add_dummies-fi.png'.replace('.png', '.eps'), format='eps')
print("Written app-id-huaweiwatch-def-add_dummies-fi.png/eps")
