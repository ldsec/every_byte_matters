...
features_and_percentages = deserialize("app-id-huaweiwatch-def-delay_group-fi.json")
...
plt.savefig('app-id-huaweiwatch-def-delay_group-fi.png', format='png')
plt.savefig('app-id-huaweiwatch-def-delay_group-fi.png'.replace('.png', '.eps'), format='eps')
print("Written app-id-huaweiwatch-def-delay_group-fi.png/eps")
