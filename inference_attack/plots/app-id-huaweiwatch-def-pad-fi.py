...
features_and_percentages = deserialize("app-id-huaweiwatch-def-pad-fi.json")
...
plt.savefig('app-id-huaweiwatch-def-pad-fi.png', format='png')
plt.savefig('app-id-huaweiwatch-def-pad-fi.png'.replace('.png', '.eps'), format='eps')
print("Written app-id-huaweiwatch-def-pad-fi.png/eps")
