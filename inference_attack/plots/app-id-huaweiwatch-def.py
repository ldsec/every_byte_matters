...
defense_results2 = deserialize("app-id-huaweiwatch-def.json")
...
write_latex_table_defense("app-id-huaweiwatch-def.tex", defense_results, labelFormat="\\defense", headerRow=False)
