...
features_and_percentages = deserialize("app-id-huaweiwatch-fi.json")
...
plt.savefig('app-id-huaweiwatch-fi.png', format='png')
plt.savefig('app-id-huaweiwatch-fi.png'.replace('.png', '.eps'), format='eps')
print("Written app-id-huaweiwatch-fi.png/eps")
