...
features_and_percentages = deserialize("chipset-id-fi.json")
...
plt.savefig('chipset-id-fi.png', format='png')
plt.savefig('chipset-id-fi.png'.replace('.png', '.eps'), format='eps')
print("Written chipset-id-fi.png/eps")
