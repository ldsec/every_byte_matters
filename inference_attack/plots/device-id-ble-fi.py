...
features_and_percentages = deserialize("device-id-ble-fi.json")
...
plt.savefig('device-id-ble-fi.png', format='png')
plt.savefig('device-id-ble-fi.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-ble-fi.png/eps")
