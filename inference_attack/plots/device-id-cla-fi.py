...
features_and_percentages = deserialize("device-id-cla-fi.json")
...
plt.savefig('device-id-cla-fi.png', format='png')
plt.savefig('device-id-cla-fi.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-cla-fi.png/eps")
