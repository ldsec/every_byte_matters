...
features_and_percentages = deserialize("device-id-def-ble-add_dummies-fi.json")
...
plt.savefig('device-id-def-ble-add_dummies-fi.png', format='png')
plt.savefig('device-id-def-ble-add_dummies-fi.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-def-ble-add_dummies-fi.png/eps")
