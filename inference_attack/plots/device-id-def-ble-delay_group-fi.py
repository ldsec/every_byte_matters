...
features_and_percentages = deserialize("device-id-def-ble-delay_group-fi.json")
...
plt.savefig('device-id-def-ble-delay_group-fi.png', format='png')
plt.savefig('device-id-def-ble-delay_group-fi.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-def-ble-delay_group-fi.png/eps")
