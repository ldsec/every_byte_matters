...
features_and_percentages = deserialize("device-id-def-ble-pad-fi.json")
...
plt.savefig('device-id-def-ble-pad-fi.png', format='png')
plt.savefig('device-id-def-ble-pad-fi.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-def-ble-pad-fi.png/eps")
