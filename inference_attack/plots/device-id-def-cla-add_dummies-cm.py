...
[y_test, y_pred] = deserialize("device-id-def-cla-add_dummies-cm.json")
...
plt.savefig('device-id-def-cla-add_dummies-cm.png', format='png')
plt.savefig('device-id-def-cla-add_dummies-cm.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-def-cla-add_dummies-cm.png/eps")
