...
[y_test, y_pred] = deserialize("device-id-def-cla-delay_group-cm.json")
...
write_latex_table_precision_recall_f1("device-id-def-cla-delay_group-cm.tex", y_test, y_pred)
plt.tight_layout()
plt.savefig('device-id-def-cla-delay_group-cm.png', format='png')
plt.savefig('device-id-def-cla-delay_group-cm.png'.replace('.png', '.eps'), format='eps')
print("Written device-id-def-cla-delay_group-cm.png/eps")
